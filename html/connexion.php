  ...
  <div class="container overflow-hidden text-center"><!-- pour une combinaison de largeurs de fluide et de pixel. -->
    <div class="row gx-5 presenting">
      <div class="col-lg-6 col-md-12" ><!-- courte présentation du site web -->
        ...
        <div class="col-12 ">
          <p class="text-description"> Est un réseau social pour partager des moments conviviaux, décrire ces humeurs et
          son ressenti à travers une photo. Acompagnée de son appareil intelligent et connectée ("")vous permet de poster en
