...
<body id="body-connexion">
    <div class="page-connexion">
      <div class="la-description"><!-- courte présentation du site web -->
        <img class="logo" src="../Images/logo nice and easy.png" alt="Logo du réseau social"> <!-- présentation en premier lieu du logo -->
        <p class="text-description"> Est un réseau social pour partager des moments conviviaux, décrire ces humeurs et son ressenti à travers une photo. Acompagnée de son appareil intelligent et connectée ("")vous permet de poster en toute simpliciter grace à un simple capteur. </p>
      ...
      <header class="fiche-connexion"> <!-- La carte connexion où l'un=tilisateur rentre toutes ces données -->
        <div class="infos-connexion">
          ...
          <div class="les-inputs">
            ...
            <div class="input-group mb-4 mb-3">
              ...
              <input type="text" name="psdin" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" autocomplete="off">
            </div> <!-- L'input pour le pseudo -->
            <div  class="input-group mt-5 mb-3 pt-2">
              <span class="input-group-text" id="basic-addon1">Mot de passe</span>
              <input type="password" name="mdpin" class="form-control" placeholder="password" aria-label="Username" aria-describedby="basic-addon1">
        ...
        <div class="btn-inscription"> <!-- ou le lien d'incription pour les non inscrits -->
          <a href="../html/inscription.php"><p>S'inscrire</p></a>
        </div>
      </header>
      </form>
    </div>
